...
const string kExternIP = GENERAL_FIELD "externIP";
const string kEthName = GENERAL_FIELD "ethName";
const string kLogRootPath = GENERAL_FIELD "log_root_path";
...
onceToken token(
    []() {
        ...
        mINI::Instance()[kEthName] = "";
        mINI::Instance()[kLogRootPath] = "";
    },
    nullptr);
...
////////////mysql相关配置///////////
namespace Mysql {
#define MYSQL_FIELD "mysql."
const string kIp = MYSQL_FIELD "ip";
const string kPort = MYSQL_FIELD "port";
const string kUser = MYSQL_FIELD "user";
const string kPassword = MYSQL_FIELD "password";

onceToken token(
    []() {
        mINI::Instance()[kIp] = "127.0.0.1";
        mINI::Instance()[kPort] = 3306;
        mINI::Instance()[kUser] = "root";
        mINI::Instance()[kPassword] = "aibox@uniubi";
    },
    nullptr);
} // namespace Mysql
